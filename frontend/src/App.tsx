...
function App() {
  ...
  return (
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden">
      {/* Navbar */}
      <nav className={`sticky top-0 z-50 glass-nav transition-shadow ${isScrolled ? 'shadow-md' : 'shadow-sm'}`}>
        <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
          <div className="flex items-center gap-8">
            <img alt="Tripzy Logo" className="h-10 w-auto" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCFmvmck7staTZo3fnqI5l0PWRG5XZzUP6Y1ay_r6e5qjkHjADZWvCgF3cNFhzC24es4Mv_dkZ0tcb0Y1-p-soNFbu65Iwf0FA6AF0eqtCThXXkd4kzboj5WbU7vEyf_qi4YUu5dMS9oTxZ32d1LWruRqAB5BV1AlBw8hc1aiaA4bi5cFogS7p299OSlr5R7V2036DpMcACUzxjHp-91clYno7HG0liLGOwDjbu9ZXj4eRS_EdE9u2O1Q" />
            <div className="hidden md:flex gap-6">
              ...
              <a className="font-label-sm text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#features">Features</a>
              <a className="font-label-sm text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">My Trips</a>
            </div>
          </div>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="z-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a className="px-8 py-4 bg-primary-container text-on-primary-fixed-variant rounded-full font-headline-md text-headline-md hover:shadow-lg transition-all scale-100 hover:scale-105 active:scale-95 text-center" href="#plan-form">
                Plan My Trip
              </a>
            </div>
          </div>
          <div className="relative group">
            ...
            <img alt="Indian Travel Illustration" className="relative z-10 w-full h-auto drop-shadow-2xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDC1sbb97uuooCeexEUYmZQ42IEduwq8kQp7rJAxM1a_ukyfB_2AQTzFCMbWLkyW_Z23julUK6ORDn9ATCGhOF3Q4CIjP65_zeKSMSdyZyLLaDqqJzvYi3-nDLpeBATsOWy8AWNGAfUifdQ_J9Otlwc2KNiROGaMA4CgHWdIbGfGRQS8PfL0hHKvrtC26lWvbfuhUj92gNZX_3HeDmFLi7c5W49yhQ908ttfF_pulkLn07uMfGoym1txQ" />
          </div>
        </div>
      </header>
      ...
      <section className="py-24 px-margin-mobile">
        <div className="max-w-container-max mx-auto rounded-3xl bg-primary-container p-12 md:p-20 text-center relative overflow-hidden elevated-shadow">
          ...
          <div className="relative z-10">
            ...
            <button className="px-12 py-5 bg-white text-primary font-headline-md text-headline-md rounded-full shadow-xl hover:shadow-2xl transition-all scale-100 hover:scale-105 active:scale-95">
              Start Planning Now
            </button>
          </div>
        </div>
